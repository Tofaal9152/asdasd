...
export default function RegistrationPage() {
  ...
  return (
    <div className="overflow-hidden h-screen">
      ...
      <div
        className={`flex h-[80vh] px-[4%] relative ${
          page !== "" ? "top-[-40rem]" : "top-[0rem]"
            ...
            <div className="flex flex-row space-x-10">
              <div className="flex flex-col">
                ...
                className="text-xs md:text-sm"
                  icon={<FaShop size={18} className="ml-2" />}
              ...
              <div className="flex flex-col">
                ...
                <IconButton
                className="text-xs md:text-sm"
                  icon={<IoPerson size={18} className="ml-2" />}
      ...
      <div
        className={`relative  ${
          page === "customer" ? "flex h-[80vh] top-[-38rem] md:mt-[4rem]" : "top-[100rem]"
        } duration-700 transition-all`}
      >
        <RegistrationCutomer  />
      </div>
      ...
      <div
        className={`relative  ${
          page === "salon" ? "flex h-[80vh] top-[-71rem] md:mt-[4rem]" : "top-[100rem]"
        } duration-700 transition-all`}
      >
        <SalonRegistration />
      </div>
